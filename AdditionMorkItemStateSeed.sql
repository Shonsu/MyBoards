...
ALTER TABLE `Comments` ADD CONSTRAINT `FK_Comments_Users_AuthorId` FOREIGN KEY (`AuthorId`) REFERENCES `Users` (`Id`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240418114000_CommentUserRelation', '8.0.4');

COMMIT;

START TRANSACTION;

INSERT INTO `WorkItemStates` (`Id`, `State`)
VALUES (1, 'To Do'),
(2, 'In progress'),
(3, 'Done');

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240418122546_WorkItemState', '8.0.4');

COMMIT;

START TRANSACTION;

INSERT INTO `WorkItemStates` (`State`)
VALUES ('On Hold');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240418131455_AdditionMorkItemStateSeed', '8.0.4');
